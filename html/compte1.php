...
<head>
    ...
    <link rel="stylesheet" href="../css/moncompte1.css">
        ...
        <div class="container-formulaire"> 
            ...
            <!--Début du formulaire-->
                <form >
                    ...
                    <input type="password" id="pwd" name="pwd" required minlength="8" maxlength="16"><br><br>
                    <input type="checkbox" id="se-souvenir" name="se-souvenir" >
                    <label for="se-souvenir"> <span>Se souvenir de moi</span></label>
                    <a href="">mot de passe oublié ? </a><br><br>
                    <a href="compte2.html ">Connexion</a>
                </form> 
                <!--fin du formulaire--> 
        </div>
    </section>         
